...
function getSortValue(letter, col) {
  ...
  if (col === "status") return letter.status || "";
...
tbody.addEventListener("click", async (e) => {
  ...
  if (act === "delete") {
    // Immediately delete and adjust counter if needed
...
btnReset.addEventListener("click", () => {
  showDialog({
    ...
    bodyHTML: `<div>Ini menghapus semua counters dan data register dari perangkat ini.</div>`,
    buttons: [
      { text: "Batal", variant: "secondary" },
      {
        text: "Ya, Reset",
